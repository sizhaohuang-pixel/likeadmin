...
<script lang="ts" setup name="agentEdit">
import type { FormInstance } from 'element-plus'
import { agentAdd, agentEdit, agentDetail } from '@/api/agent'
...
const popupTitle = computed(() => {
    return mode.value == 'edit' ? '编辑代理商' : '新增代理商'
})
...
const handleSubmit = async () => {
    ...
    mode.value == 'edit' ? await agentEdit(data) : await agentAdd(data)
